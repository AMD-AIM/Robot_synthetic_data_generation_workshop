...
Usage:
  python 02_train_smolvla.py --dataset-id local/so101-genesis-pick --n-steps 2000
  python 02_train_smolvla.py --dataset-id local/so101-genesis-pick --n-steps 100 --batch-size 2
"""
